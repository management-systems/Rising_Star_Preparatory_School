...
const events = [
  { title: 'Summer Camp 2025', date: 'May 1 – May 30, 2025', desc: 'Swimming, yoga, art, and fun workshops for enrolled and new students.', status: 'upcoming' },
  { title: 'Annual Day Celebration', date: 'March 20, 2025', desc: 'Your child performs on stage! Dance, drama, and award ceremony.', status: 'upcoming' },
  { title: 'Parent-Teacher Meeting', date: 'March 5, 2025', desc: 'One-on-one discussion about your child\'s progress with their class teacher.', status: 'upcoming' },
  { title: 'Open House & Campus Tour', date: 'February 22, 2025', desc: 'Visit the school, meet educators, and explore our facilities.', status: 'upcoming' },
  { title: 'Republic Day Celebration', date: 'January 26, 2025', desc: 'Flag hoisting, patriotic songs, and fancy dress by our little ones.', status: 'past' },
  { title: 'Christmas & New Year Party', date: 'December 22, 2024', desc: 'Holiday fun with Santa, gifts, cake, and class activities.', status: 'past' },
];
